    ...
    <button type="button" class="btn btn-primary" > <a href="historique_mois_dernier.php"style="color: white;">Mois dernier</a></button>
...
<caption style="text-align: center;"><strong>Le nombre de congés pris cette année :</strong>
    <?php     
        ...
        FROM conges c,Personne p
        WHERE YEAR( date_fin) = YEAR( CURDATE())
        AND (p.Cin_personne = c.personne)
        AND (p.service = 4)";
